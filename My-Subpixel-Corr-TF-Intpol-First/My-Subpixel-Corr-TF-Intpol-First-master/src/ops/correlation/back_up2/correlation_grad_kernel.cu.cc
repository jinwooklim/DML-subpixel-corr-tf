...
//                    float input_b_tmp = input_b[idx_input_b];
                    ...
                    if(((s2p%2) == 0) && ((s2o%2) == 0)) {
                        ...
                        int idx_input_b_01 = ((item * padded_in_height + (y - s2p)) * padded_in_width + (x - s2o)) * in_channels + k;
                        int idx_input_b_02 = ((item * padded_in_height + (y - s2p)) * padded_in_width + (x - s2o + 1)) * in_channels + k;
                        input_b_tmp = (input_b[idx_input_b_01] + input_b[idx_input_b_02]) / 2.0;
                    } else if (((s2p%2) == 1) && ((s2o%2) == 0)) {
                        int idx_input_b_01 = ((item * padded_in_height + (y - s2p)) * padded_in_width + (x - s2o)) * in_channels + k;
                        int idx_input_b_03 = ((item * padded_in_height + (y - s2p + 1)) * padded_in_width + (x - s2o)) * in_channels + k;
                        input_b_tmp = (input_b[idx_input_b_01] + input_b[idx_input_b_03]) / 2.0;
                    } else if (((s2p%2) == 1) && ((s2o%2) == 1)) {
                        int idx_input_b_01 = ((item * padded_in_height + (y - s2p)) * padded_in_width + (x - s2o)) * in_channels + k;
                        int idx_input_b_02 = ((item * padded_in_height + (y - s2p)) * padded_in_width + (x - s2o + 1)) * in_channels + k;
                        int idx_input_b_03 = ((item * padded_in_height + (y - s2p + 1)) * padded_in_width + (x - s2o)) * in_channels + k;
                        int idx_input_b_04 = ((item * padded_in_height + (y - s2p + 1)) * padded_in_width + (x - s2o + 1)) * in_channels + k;
                        input_b_tmp = (input_b[idx_input_b_01] + input_b[idx_input_b_02] + input_b[idx_input_b_03] + input_b[idx_input_b_04]) / 4.0;
                    }

//                    // Version # 2
//                    float input_b_tmp;
//                    if((((y-s2p)%2) == 0) && (((x-s2o)%2) == 0)) {
//                        int idx_input_b_01 = ((item * padded_in_height + (y - s2p)) * padded_in_width + (x - s2o)) * in_channels + k;
//                        input_b_tmp = input_b[idx_input_b_01];
//                    } else if ((((y-s2p)%2) == 0) && (((x-s2o)%2) == 1)) {
//                        int idx_input_b_01 = ((item * padded_in_height + (y - s2p)) * padded_in_width + (x - s2o)) * in_channels + k;
//                        int idx_input_b_02 = ((item * padded_in_height + (y - s2p)) * padded_in_width + (x - s2o + 1)) * in_channels + k;
//                        input_b_tmp = (input_b[idx_input_b_01] + input_b[idx_input_b_02]) / 2.0;
//                    } else if ((((y-s2p)%2) == 1) && (((x-s2o)%2) == 0)) {
//                        int idx_input_b_01 = ((item * padded_in_height + (y - s2p)) * padded_in_width + (x - s2o)) * in_channels + k;
//                        int idx_input_b_03 = ((item * padded_in_height + (y - s2p + 1)) * padded_in_width + (x - s2o)) * in_channels + k;
//                        input_b_tmp = (input_b[idx_input_b_01] + input_b[idx_input_b_03]) / 2.0;
//                    } else if ((((y-s2p)%2) == 1) && (((x-s2o)%2) == 1)) {
//                        int idx_input_b_01 = ((item * padded_in_height + (y - s2p)) * padded_in_width + (x - s2o)) * in_channels + k;
//                        int idx_input_b_02 = ((item * padded_in_height + (y - s2p)) * padded_in_width + (x - s2o + 1)) * in_channels + k;
//                        int idx_input_b_03 = ((item * padded_in_height + (y - s2p + 1)) * padded_in_width + (x - s2o)) * in_channels + k;
//                        int idx_input_b_04 = ((item * padded_in_height + (y - s2p + 1)) * padded_in_width + (x - s2o + 1)) * in_channels + k;
