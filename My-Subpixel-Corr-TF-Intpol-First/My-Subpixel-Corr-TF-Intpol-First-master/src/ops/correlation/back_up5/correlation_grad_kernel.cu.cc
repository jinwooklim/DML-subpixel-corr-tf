   ...
   const float *gradient)
{
    CUDA_1D_KERNEL_LOOP(index_i, nthreads) {
        ...
        int x = (index_i / in_channels) % interpolated_width + pad_size;             // w-pos
        int y = (index_i / in_channels / interpolated_width) % interpolated_height + pad_size; // h-pos
...
//                    float input_b_tmp = input_b[idx_input_b];
                    ...
                    if((o%2 == 0) && (p%2 == 0)) {
                        ...
                        if(p >= 0) {
                            idx_input_b_01 = ((item * padded_in_height + (y + s2p)) * padded_in_width + (x + s2o)) * in_channels + k;
                            idx_input_b_03 = ((item * padded_in_height + (y + s2p + 1)) * padded_in_width + (x + s2o + 1)) * in_channels + k;
                        }
                        else {
                            idx_input_b_01 = ((item * padded_in_height + (y + s2p)) * padded_in_width + (x + s2o)) * in_channels + k;
                            idx_input_b_03 = ((item * padded_in_height + (y + s2p - 1)) * padded_in_width + (x + s2o + 1)) * in_channels + k;
...
//                    float input_a_tmp = input_a[idx_input_a];
                    ...
                    if((o%2 == 0) && (p%2 == 0)) {
                        int idx_input_b_01 = ((item * padded_in_height + (y + s2p)) * padded_in_width + (x + s2o)) * in_channels + k;
                        input_a_tmp = input_a[idx_input_a];
                    }
                    else if((o%2 == 1) && (p%2 == 0)) {
                        ...
                        if(p >= 0) {
                            idx_input_a_01 = ((item * padded_in_height + (y + s2p)) * padded_in_width + (x + s2o)) * in_channels + k;
                            idx_input_a_03 = ((item * padded_in_height + (y + s2p + 1)) * padded_in_width + (x + s2o + 1)) * in_channels + k;
                        }
                        else {
                            idx_input_a_01 = ((item * padded_in_height + (y + s2p)) * padded_in_width + (x + s2o)) * in_channels + k;
                            idx_input_a_03 = ((item * padded_in_height + (y + s2p - 1)) * padded_in_width + (x + s2o + 1)) * in_channels + k;
