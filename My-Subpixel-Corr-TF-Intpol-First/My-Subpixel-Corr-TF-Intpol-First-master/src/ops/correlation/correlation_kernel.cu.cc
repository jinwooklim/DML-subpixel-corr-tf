...
__global__ void CorrelateData(int          batch_size,
  ...
  for (int out_channel = 0; out_channel < out_channels; out_channel++) {
    ...
    int s2o = (out_channel % neighborhood_grid_width - neighborhood_grid_radius) * (int)stride_2;
    int s2p = (out_channel / neighborhood_grid_width - neighborhood_grid_radius) * (int)stride_2;
