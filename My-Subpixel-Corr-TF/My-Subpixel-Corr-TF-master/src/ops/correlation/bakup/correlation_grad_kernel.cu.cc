                                       ...
                                       const float *gradient)
{
  CUDA_1D_KERNEL_LOOP(index, nthreads) {
    ...
    const int round_off_s1 = (int)stride_1 * round_off;
    ...
    if ((xmax >= 0) && (ymax >= 0) && (xmin <= out_width - 1) && (ymin <= out_height - 1)) {
      ...
      for (int p = (int)-neighborhood_grid_radius; p <=(int)neighborhood_grid_radius; p++) {
        for (int o = (int)neighborhood_grid_radius; o <= (int)neighborhood_grid_radius; o++) {
          // Get input_b data:
          float s2o         = stride_2 * o;
          float s2p         = stride_2 * p;

	  int s2o_1 = (int)s2o;
	  int s2o_2 = (int)s2o_1 + int(s2o*2)%2;
	  int s2p_1 = (int)s2p;
	  int s2p_2 = (int)s2p_1 + int(s2p*2)%2;
	  ...
	  int idx_input_b_11 = ((item * padded_in_height + (y + s2o_1)) * padded_in_width + (x + s2o_1)) * in_channels + k;
	  int idx_input_b_12 = ((item * padded_in_height + (y + s2o_1)) * padded_in_width + (x + s2o_2)) * in_channels + k;
	  int idx_input_b_21 = ((item * padded_in_height + (y + s2o_1)) * padded_in_width + (x + s2o_1)) * in_channels + k;
	  int idx_input_b_22 = ((item * padded_in_height + (y + s2o_1)) * padded_in_width + (x + s2o_1)) * in_channels + k;
